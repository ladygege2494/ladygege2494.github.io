实验考只要 PTA 上的题都会做就没问题，即使小白大不了多刷一点。理论考最大的观感就是考得很细很琐碎。
## 我的笔记
大一刚进来的时候有零点编程基础，现在回看笔记记得有点子啰嗦，仅供参考。

<embed src="../assets/c程设计基础与实验/C程知识点.pdf" type="application/pdf" width="100%" height="600px" />
